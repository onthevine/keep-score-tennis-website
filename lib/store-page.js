...
export const APP_STORE_ID = "6804699922";
...
export function storePage({ badge = "", sub = "" } = {}) {
  ...
  // Runs before render. If the app IS installed, the OS intercepts the URL
  // before the page ever loads, so this only runs for people without it.
  const redirectScript = `
    ...
    // Desktop falls through to the page body.
  `;

  const appStoreButton = `<a class="store-btn" href="${APP_STORE_URL}">
